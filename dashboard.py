...
def create_products_revenue_df():
    products_df = pd.read_csv("clean/products.csv")
    order_items_df = pd.read_csv("clean/order_items.csv")
    orders_df = pd.read_csv("clean/orders.csv")
    order_payments_df = pd.read_csv("clean/order_payments.csv")
